        ...
        <div class="row">
          <div class="col-md-12 copyright">
            ...
            <ul class="list-inline social-links">
              ...
              <li><a href="https://web.facebook.com/agentelias" class="icon-facebook" rel="tooltip" title="" data-placement="bottom" data-original-title="Facebook"><i class="fa fa-facebook"></i></a></li>
              ...
              <li><a href="https://www.instagram.com/eliasproperties/" class="icon-instagram" rel="tooltip" title="" data-placement="bottom" data-original-title="instagram"><i class="fa fa-instagram"></i></a></li>
            </ul>
          </div>
        </div>
        <!-- end:copyright -->
